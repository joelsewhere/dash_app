...
- value (string | number; optional): The value of the currently selected option.
...
or 'lg' (large). Default is 'md'."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, value=Component.UNDEFINED, options=Component.UNDEFINED, disabled=Component.UNDEFINED, valid=Component.UNDEFINED, invalid=Component.UNDEFINED, bs_size=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'style', 'className', 'key', 'value', 'options', 'disabled', 'valid', 'invalid', 'bs_size']
        self._type = 'Select'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'style', 'className', 'key', 'value', 'options', 'disabled', 'valid', 'invalid', 'bs_size']
